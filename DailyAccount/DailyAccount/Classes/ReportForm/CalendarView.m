...
@interface PWSCalendarView()<PWSCalendarSegmentDelegate,PWSCalendarDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
{
    // data
...
- (void) SetHeadView
{
    ...
    [m_label_time setFrame:CGRectMake(0, origin_x+15, width, 30)];
    ...
    // segment
    origin_x += 50;
    NSArray* items = [NSArray arrayWithObjects:[self GetSegmentItemWithTitle:@"当天"], [self GetSegmentItemWithTitle:@"本周"], [self GetSegmentItemWithTitle:@"本月"], nil];
...
- (void) SetCollectionView
{
    ...
    m_view_calendar = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 125, width, height-80) collectionViewLayout:layout];
